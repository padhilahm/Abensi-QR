								...
								<tbody>
									...
									foreach ($absen_lihat as $absen) { ?>
										<tr>
											...
											<td>
												<?php echo $absen->nis_siswa; ?>
											</td>
											<td>
												<div class="form-button-action">
													<a href="<?= base_url() ?>admin/siswa_info/<?= $absen->id_siswa; ?>" class="btn btn-link btn-primary btn-lg"><i class="fas fa-info-circle" data-original-title="Info"></i></a>
