		...
		<div class="page-inner mt--5">
			<div class="col-md-12">
				...
				<div class="card-body">
					...
					<form method="post" action="<?= base_url(); ?>admin/siswa_tambah">
						<div class="row">
							<div class="col-sm-6">
								<div id="siswa_hidden_nama_div" class="form-group form-group-default">
									<div id="siswa_hidden_nama">
										<label>Nama</label>
										<input id="nama_siswa" required="" name="nama_siswa" type="text" class="form-control" placeholder="Masukkan nama siswa" value="">
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div id="siswa_hidden_nis_div" class="form-group form-group-default">
									<div id="siswa_hidden_nis">
										<label>NIS</label>
										<input id="nis_siswa" name="nis_siswa" required="" type="text" class="form-control" placeholder="Masukkan NIS" value="">
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div id="siswa_hidden_tanggal_lahir_div" class="form-group form-group-default">
									<div id="siswa_hidden_tanggal_lahir">
										...
										<input id="tangal_lahir" name="tanggal_lahir" required="" type="date" class="form-control" placeholder="Masukkan tanggal lahir" value="">
									</div>
								</div>
							</div>
